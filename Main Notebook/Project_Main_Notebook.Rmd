...
```{r echo=FALSE}
cat(sprintf("The European call options total book value is %.2f$.\n", PF_price_1))
cat(sprintf("The options are worth respectively %.2f$, %.2f$, %.2f$, %.2f$.", call_price[1], call_price[2], call_price[3], call_price[4]))
```
